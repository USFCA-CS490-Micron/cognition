...
def train():
    ...
    model_output_path = os.path.join(current_directory, "../model-builds/hybrid-determination")
    training_data_path = os.path.join(current_directory, "../data/decision_data.csv")
    results_path = os.path.join(current_directory, "./hybrid-determination-results")
